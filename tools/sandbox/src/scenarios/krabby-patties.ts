...
export const krabbyPattiesScenario: ScenarioDefinition = {
  meta: {
    ...
    description:
      "Plankton submits a massive order for 10,000 Krabby Patties. The entire Krusty Krab mobilizes. SpongeBob's kitchen produces faster than Squidward can deliver — a classic producer-consumer bottleneck threatens to sink the operation.",
    duration: "3 minutes",
  ...
  phases: [
    {
      ...
      narrative:
        "🦠 Plankton walks in and orders 10,000 Krabby Patties. Mr. Krabs sees dollar signs. The entire org mobilizes.",
    },
    {
      id: "kitchen-heats-up",
      ...
      unlocksEpics: [
        ...
        "marketing-coverage",
        "parallel-security-investigation",
      ],
      enabledEvents: [
        "grill-malfunction",
        "ingredient-shortage",
        "intern-disaster",
        "plankton-suspicious-activity",
      ],
      difficultyMod: 1.0,
      transition: { type: "hybrid", tick: 80, condition: { epicsDone: 3 } },
      narrative:
        "🧽 SpongeBob decomposes the order into batches. Sandy architects the parallel pipeline. The kitchen is ON FIRE (metaphorically).",
    },
    {
      id: "delivery-crisis",
      name: "Act 3: Order Up! — The Delivery Crisis",
      tickRange: [60, 150],
      unlocksEpics: ["delivery-operations", "order-tracking-ui", "support-ticket-surge"],
      enabledEvents: [
        "squidward-drops-order",
        "wrong-table-delivery",
        "customer-complaint-wave",
        "grill-malfunction",
        "plankton-suspicious-activity",
      ],
      difficultyMod: 1.5,
      ...
      narrative:
        "🐙 Squidward is the ONLY delivery agent. 8 batches/tick vs 50 produced. The window queue grows. Chaos ensues.",
    },
    {
      id: "the-bottleneck",
      ...
      transition: {
        type: "hybrid",
        tick: 200,
        condition: { specificEpics: ["resource-reallocation"] },
      },
      narrative:
        "🐙 \"I CAN'T DELIVER 10,000 BY MYSELF!\" — 200+ batches backed up. SpongeBob's team idles. Mr. Krabs faces THE DECISION.",
    },
    {
      ...
      narrative:
        "📦 Pearl + Fred join delivery. Rate triples. Queue drains. Quality recovers. 10,000 Krabby Patties — DELIVERED.",
    },
  ],
  ...
  epics: [
...

    {
      ...
      taskTemplates: [
        {
          id: "validate-order",
          title: "Validate Order — 10,000 Krabby Patties",
          domain: "operations",
          subtasks: [
        ...
        },
        {
          ...
          title: "Delegate to SpongeBob — Production Plan",
          domain: "engineering",
          subtasks: [
          ...
          crossDeptTriggers: [{ action: "unlock_epic", target: "batch-production-pipeline" }],
        },
        {
          id: "delegate-delivery",
          title: "Delegate to Squidward — Delivery Plan",
          domain: "operations",
          subtasks: [
          ...
          dependsOnTasks: ["validate-order"],
          crossDeptTriggers: [{ action: "unlock_epic", target: "delivery-operations" }],
        },
      ],
    },
    {
      ...
      taskTemplates: [
        ...
        },
        {
          ...
          domain: "finance",
          subtasks: [
            { title: "Price × 10,000 calculation", durationRange: [1, 2] },
      ...
      taskTemplates: [
        {
          ...
          domain: "security",
          subtasks: [
            { title: "Flag order as suspicious — Plankton history", durationRange: [1, 2] },
            { title: "Karen runs background check", durationRange: [2, 3] },
            { title: "Mermaid Man monitors API access logs", durationRange: [2, 3] },
          ],
          durationRange: [1, 3],
          reviewRequired: true,
          crossDeptTriggers: [{ action: "unlock_epic", target: "parallel-security-investigation" }],
        },
      ],
    },

    // ── ACT 2: The Kitchen Heats Up ───────────────────────────────────────
      ...
      taskTemplates: [
        {
          ...
          title: "Pipeline Architecture — Sandy's Design",
          domain: "engineering",
          subtasks: [
        ...
        },
        {
          ...
          title: "Batch Execution — Batches 1-2500",
          domain: "backend",
          subtasks: [
        ...
        },
        {
          ...
          title: "Batch Execution — Batches 2501-5000",
          domain: "backend",
          subtasks: [
        ...
        },
        {
          ...
          title: "Batch Execution — Batches 5001-7500",
          domain: "backend",
          subtasks: [
        ...
        },
        {
          ...
          title: "Batch Execution — Batches 7501-10000",
          domain: "backend",
          subtasks: [
    ...
    // ── ACT 3: Order Up! — The Delivery Crisis ───────────────────────────

    {
      ...
      taskTemplates: [
        ...
        {
          id: "delivery-batch-1",
          title: "Delivery Run — Batches 1-500",
          domain: "operations",
          subtasks: [
        ...
        {
          id: "delivery-batch-2",
          title: "Delivery Run — Batches 501-1500 (errors climbing)",
          domain: "operations",
          subtasks: [
        ...
        {
          id: "delivery-batch-3",
          title: "Delivery Run — Batches 1501-2500 (crisis mode)",
          domain: "operations",
          subtasks: [
      ...
      taskTemplates: [
        {
          ...
          subtasks: [
            ...
            { title: "Fred × 3 process basic tickets", durationRange: [3, 5] },
          ],
          durationRange: [2, 5],
          reviewRequired: false,
        },
        {
          ...
          domain: "operations",
          subtasks: [
            { title: "Wrong table deliveries — re-route", durationRange: [3, 5] },
            { title: "Cold patty complaints — re-make queue", durationRange: [3, 5] },
            { title: "Missing order complaints — track & locate", durationRange: [3, 5] },
      ...
      taskTemplates: [
        ...
        },
        {
          ...
          subtasks: [
            ...
            { title: "Reassign Fred ×3 from support to delivery", durationRange: [1, 2] },
          ],
          durationRange: [1, 3],
          reviewRequired: true,
      ...
      taskTemplates: [
        {
          ...
          subtasks: [
            ...
            { title: "Fred ×3 briefed on delivery protocol", durationRange: [2, 3] },
        ...
        {
          id: "delivery-batch-4",
          title: "Scaled Delivery — Batches 2501-5000",
          domain: "operations",
          subtasks: [
        ...
        {
          id: "delivery-batch-5",
          title: "Scaled Delivery — Batches 5001-7500",
          domain: "operations",
          subtasks: [
            { title: "Parallel delivery: 3 routes active", durationRange: [4, 6] },
            { title: "Queue draining — depth dropping", durationRange: [4, 6] },
            { title: "Error rate recovering: 18% → 5%", durationRange: [3, 5] },
          ],
          durationRange: [3, 6],
          reviewRequired: true,
        ...
        {
          id: "delivery-batch-6",
          title: "Scaled Delivery — Batches 7501-10000 (THE HOME STRETCH)",
          domain: "operations",
          subtasks: [
            { title: "Deliver batches 7501-8500", durationRange: [4, 6] },
            { title: "Deliver batches 8501-9500", durationRange: [4, 6] },
            { title: "Deliver batches 9501-10000 — DONE!", durationRange: [3, 5] },
          ],
          durationRange: [3, 6],
          reviewRequired: false,
      ...
      taskTemplates: [
        {
          ...
          subtasks: [
            ...
            { title: "Close investigation — no formula compromise", durationRange: [1, 2] },
          ],
          durationRange: [1, 3],
          reviewRequired: false,
        },
  ...
  events: [
    {
      ...
      cooldownTicks: 25,
      narrative:
        "🔥 One of Sandy's parallel grill stations overheated! Patrick is panicking. Production drops temporarily.",
      effect: {
        createTasks: [
          {
    ...
    },
    {
      ...
      maxOccurrences: 2,
      narrative:
        "🥬 We're running low on secret sauce! Sandy dispatches Patrick to the supplier. Production slows.",
      effect: {
        createTasks: [
          {
    ...
    },
    {
      ...
      maxOccurrences: 1,
      narrative:
        "🦠 Plankton Jr. accidentally dumped a batch into the wrong container. Gary is NOT happy. QA cycle triggered.",
      effect: {
        createTasks: [
          {
    ...
    },
    {
      ...
      cooldownTicks: 15,
      narrative:
        "🐙 Squidward dropped a tray of 50 patties! They need to be re-made AND re-delivered.",
      effect: {
        createTasks: [
          {
    ...
    },
    {
      ...
      probability: 0.07,
      cooldownTicks: 10,
      narrative: "🪑 Squidward delivered to the WRONG TABLE again. Complaints incoming.",
      effect: {
        createTasks: [
          {
    ...
    },
    {
      ...
      probability: 0.05,
      cooldownTicks: 20,
      narrative: '📱 Support tickets spiking! "WHERE\'S MY ORDER?!" Barnacle Boy needs backup.',
      effect: {
        expandEpic: {
          taskCount: 3,
          domain: "operations",
    ...
    },
    {
      ...
      maxOccurrences: 4,
      narrative:
        "🧫 Karen detected Plankton accessing the tracking API again. That's access #${count}. Mermaid Man is watching.",
      effect: {
        createTasks: [
          {
    ...
    },
    {
      ...
      durationTicks: 10,
      narrative:
        "🐙💀 Squidward has SNAPPED. \"I QUIT! I'M DONE! I'M—\" Mr. Krabs talks him down. 10-tick slowdown.",
      effect: {
    ...
    },
    {
      ...
      maxOccurrences: 2,
      narrative:
        '💰 Squilliam: "The overtime is eating our margin!" Mrs. Puff confirms — costs up 40%.',
      effect: {
    ...
    dimensions: [
      {
        id: "throughput",
        name: "Throughput",
        description: "Patties produced and delivered per tick",
      },
      { id: "quality", name: "Quality", description: "Batch QA pass rate and delivery accuracy" },
      {
        id: "efficiency",
        name: "Efficiency",
        description: "Resource utilization and waste minimization",
      },
      { id: "resilience", name: "Resilience", description: "Recovery from bottlenecks and events" },
      {
        id: "customer-satisfaction",
        name: "Customer Satisfaction",
        description: "Complaint rate and resolution speed",
      },
      { id: "profitability", name: "Profitability", description: "Final P&L — revenue vs costs" },
    ],
    weights: {
      throughput: 25,
      quality: 20,
    ...
    grades: [
      {
        grade: "S",
        minScore: 90,
        label: "Krabby Patty PERFECTION. Mr. Krabs is crying tears of joy.",
      },
      {
        grade: "A",
        minScore: 80,
        label: "Outstanding operation. Squidward only complained twice.",
      },
      {
        grade: "B",
        minScore: 70,
        label: "Solid delivery. Some hiccups but the patties got there.",
      },
