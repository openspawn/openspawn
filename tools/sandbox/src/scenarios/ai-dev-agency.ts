...
export const aiDevAgencyScenario: ScenarioDefinition = {
  meta: {
    ...
    description:
      "BikiniBottom AI takes on two client projects and an internal platform upgrade simultaneously. Ship features, fight fires, bill hours.",
    duration: "20 minutes",
  ...
  phases: [
    ...
    },
    {
      ...
      transition: {
        type: "hybrid",
        tick: 320,
        condition: { specificEpics: ["alpha-demo-env", "beta-demo-env"] },
      },
      ...
      taskTemplates: [
        {
          ...
          crossDeptTriggers: [{ action: "unlock_epic", target: "alpha-model-eval" }],
        },
        {
          id: "alpha-env-setup",
      ...
      taskTemplates: [
        {
          ...
          durationRange: [3, 5],
          reviewRequired: true,
          crossDeptTriggers: [{ action: "unlock_epic", target: "beta-prompt-suite" }],
        },
        {
          id: "beta-env-setup",
