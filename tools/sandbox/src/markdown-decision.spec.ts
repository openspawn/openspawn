...
function makeAgent(id: string, name: string): SandboxAgent {
  return {
    id, name, role: 'worker', level: 4, domain: 'Engineering', status: 'active',
    systemPrompt: '', taskIds: [], recentMessages: [], trigger: 'polling', inbox: [],
...
- Message: Assigning Safari crash fix to engineering`;
  ...
  it('handles all valid actions', () => {
    const actions: DecisionAction[] = ['delegate', 'escalate', 'complete', 'work', 'message', 'hire', 'idle'];
