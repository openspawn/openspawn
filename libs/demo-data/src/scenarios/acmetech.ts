...
export const PROJECT_PHASES: PhaseInfo[] = [
  {
    id: "discovery",
    name: "Discovery",
    description: "Market research & customer insights",
    week: "Week 1-2",
    color: "#8b5cf6",
    icon: "🔍",
  },
  {
    id: "definition",
    name: "Definition",
    description: "PRD, architecture & wireframes",
    week: "Week 3-4",
    color: "#3b82f6",
    icon: "📋",
  },
  ...
  },
  {
    id: "go-to-market",
    name: "Go-to-Market",
    description: "Content, sales prep & docs",
    week: "Week 9-10",
    color: "#f59e0b",
    icon: "📣",
  },
  {
    id: "launch",
    name: "Launch",
    description: "Deploy, campaigns & outreach",
    week: "Week 11",
    color: "#ef4444",
    icon: "🚀",
  },
  {
    id: "growth",
    name: "Growth",
    description: "Metrics, feedback & iteration",
    week: "Week 12+",
    color: "#06b6d4",
    icon: "📈",
  },
...
const messages: DemoMessage[] = [
  // Discovery phase messages
  {
    ...
    content:
      "Competitive analysis complete! Key finding: nobody has good agent hierarchy visualization. Big opportunity.",
    type: DemoMessageCategory.REPORT,
    taskRef: "NT-001",
    read: true,
    createdAt: daysAgo(2),
  },
  {
    ...
    content:
      "Opportunity brief ready for review. Recommending we prioritize the network visualization feature based on research.",
  ...
  },
  {
    ...
    toAgentId: AGENT_IDS.productDirector,
    content:
      "Approved. Allocating 40K credits to Product and 50K to Engineering for Q2. Let's ship this.",
    type: DemoMessageCategory.STATUS,
    taskRef: "NT-003",
    read: true,
    createdAt: daysAgo(3),
  ...
  // Definition phase messages
  {
    ...
    content:
      "PRD draft ready for technical review. Key question: can we do real-time sync on the network graph?",
  ...
  },
  {
    ...
    content:
      "Yes, we can use WebSocket subscriptions. Added technical notes to the PRD. Estimating 40 story points total.",
    type: DemoMessageCategory.STATUS,
    taskRef: "NT-005",
    read: true,
    createdAt: daysAgo(5),
  },
  {
    ...
    toAgentId: AGENT_IDS.productManager,
    content:
      "Wireframes approved! Moving to high-fidelity. Should we sync with Frontend before I hand off?",
    type: DemoMessageCategory.QUESTION,
    taskRef: "NT-006",
    read: true,
    createdAt: daysAgo(6),
  ...
  },
  {
    ...
    content:
      "LGTM! Clean implementation. One suggestion: add rate limiting before we ship to production.",
    type: DemoMessageCategory.STATUS,
    taskRef: "NT-008",
    read: true,
    createdAt: daysAgo(8),
  },
  {
    ...
    content:
      "The network visualization is coming together! Can you review the interaction patterns?",
    type: DemoMessageCategory.QUESTION,
    taskRef: "NT-010",
    read: true,
    createdAt: daysAgo(10),
  },
  {
    ...
    content:
      "Looks great! Minor tweak: increase the node hover size for better touch targets on mobile.",
    type: DemoMessageCategory.STATUS,
    taskRef: "NT-010",
    read: true,
    createdAt: daysAgo(10),
  },
  {
    ...
    toAgentId: AGENT_IDS.techLead,
    content:
      "Found a bug in task transitions: cancelled tasks can still be reopened. Should I file this as critical?",
  ...
  // Go-to-market phase messages
  {
    ...
    toAgentId: AGENT_IDS.productManager,
    content:
      "Working on launch copy. What's the one thing that makes v2.0 special? Need the hero headline.",
    type: DemoMessageCategory.QUESTION,
    taskRef: "NT-014",
    read: true,
  ...
  },
  {
    ...
    content:
      '"Command center for your AI agent army" - it\'s the visibility + control combo. Nobody else does this well.',
    type: DemoMessageCategory.STATUS,
    read: true,
  ...
  },
  {
    ...
    toAgentId: AGENT_IDS.coo,
    content:
      "Sales deck in progress. Question: are we doing a launch discount? Need to know for pricing slide.",
    type: DemoMessageCategory.QUESTION,
    taskRef: "NT-016",
    read: false,
  ...
  },
  {
    ...
    content:
      "Top 3: (1) How do agent levels work? (2) How do I set budgets? (3) What happens when an agent runs out of credits?",
    type: DemoMessageCategory.REPORT,
    read: false,
...
const credits: DemoCreditTransaction[] = [
  ...
  {
    id: "cred-nt-001",
    agentId: AGENT_IDS.productDirector,
    type: CreditType.CREDIT,
    amount: 15000,
    description: "Q2 Product budget allocation",
    createdAt: daysAgo(0),
  },
  {
    id: "cred-nt-002",
    agentId: AGENT_IDS.engDirector,
    type: CreditType.CREDIT,
    amount: 20000,
    description: "Q2 Engineering budget allocation",
    createdAt: daysAgo(0),
  },
  {
    id: "cred-nt-003",
    agentId: AGENT_IDS.designLead,
    type: CreditType.CREDIT,
    amount: 10000,
    description: "Q2 Design budget allocation",
    createdAt: daysAgo(0),
  },
  {
    id: "cred-nt-004",
    agentId: AGENT_IDS.marketingLead,
    type: CreditType.CREDIT,
    amount: 12000,
    description: "Q2 Marketing budget allocation",
    createdAt: daysAgo(0),
  },
  {
    id: "cred-nt-005",
    agentId: AGENT_IDS.salesLead,
    type: CreditType.CREDIT,
    amount: 11000,
    description: "Q2 Sales budget allocation",
    createdAt: daysAgo(0),
  },
  {
    id: "cred-nt-006",
    agentId: AGENT_IDS.csLead,
    type: CreditType.CREDIT,
    amount: 9000,
    description: "Q2 CS budget allocation",
    createdAt: daysAgo(0),
  },
  ...
  {
    id: "cred-nt-007",
    agentId: AGENT_IDS.userResearcher,
    type: CreditType.CREDIT,
    amount: 150,
    description: "Task completion: NT-001",
    taskId: "task-nt-001",
    createdAt: daysAgo(2),
  },
  {
    ...
    type: CreditType.CREDIT,
    amount: 150,
    description: "Task completion: NT-002",
    taskId: "task-nt-002",
    createdAt: daysAgo(3),
  },
  {
    ...
    type: CreditType.CREDIT,
    amount: 300,
    description: "Task completion: NT-003",
    taskId: "task-nt-003",
    createdAt: daysAgo(4),
  },
  {
    id: "cred-nt-010",
    agentId: AGENT_IDS.backendDev,
    type: CreditType.CREDIT,
    amount: 250,
    description: "Task completion: NT-008",
    taskId: "task-nt-008",
    createdAt: daysAgo(9),
  },
  {
    ...
    type: CreditType.CREDIT,
    amount: 250,
    description: "Task completion: NT-009",
    taskId: "task-nt-009",
    createdAt: daysAgo(10),
  },
  {
    ...
    type: CreditType.CREDIT,
    amount: 200,
    description: "Task completion: NT-010",
    taskId: "task-nt-010",
    createdAt: daysAgo(11),
  },
  ...
  // Model usage spending
  {
    ...
    amount: 45,
    description: "Model usage: GPT-4o-mini",
    createdAt: daysAgo(1),
  },
  {
    id: "cred-nt-014",
    agentId: AGENT_IDS.productManager,
    type: CreditType.DEBIT,
    amount: 120,
    description: "Model usage: GPT-4o",
    createdAt: daysAgo(4),
  },
  {
    id: "cred-nt-015",
    ...
    type: CreditType.DEBIT,
    amount: 180,
    description: "Model usage: Claude Sonnet",
    createdAt: daysAgo(5),
  },
  {
    id: "cred-nt-016",
  ...
  {
    id: "cred-nt-018",
    agentId: AGENT_IDS.contentWriter,
    type: CreditType.DEBIT,
    amount: 65,
    description: "Model usage: Claude Sonnet",
    createdAt: hoursAgo(5),
...
const events: DemoEvent[] = [
  ...
  },
  {
    ...
    type: "phase.started",
    severity: EventSeverity.INFO,
    message: "📋 Definition phase started",
    metadata: { phase: "definition" },
    createdAt: daysAgo(4),
  },
  {
    id: "evt-nt-004",
    type: "phase.completed",
    severity: EventSeverity.SUCCESS,
    message: "✅ Definition phase completed",
    metadata: { phase: "definition" },
    createdAt: daysAgo(7),
  },
  {
  ...
  // Key milestones
  {
    ...
    severity: EventSeverity.SUCCESS,
    message: "PRD approved by leadership",
    agentId: AGENT_IDS.productDirector,
    createdAt: daysAgo(6),
  },
  {
  ...
  },
  {
    ...
    type: "milestone.reached",
    severity: EventSeverity.SUCCESS,
    message: "Design handoff complete",
    agentId: AGENT_IDS.designLead,
    createdAt: daysAgo(8),
  },
  {
    ...
    type: "milestone.reached",
    severity: EventSeverity.SUCCESS,
    message: "API development complete",
    agentId: AGENT_IDS.techLead,
    createdAt: daysAgo(10),
  },
  ...
  },
  {
    ...
    type: "task.completed",
    severity: EventSeverity.INFO,
    message: "Network visualization shipped",
    agentId: AGENT_IDS.frontendDev,
    taskId: "task-nt-010",
    createdAt: daysAgo(11),
  },
  ...
  // Budget events
  {
    ...
    severity: EventSeverity.INFO,
    message: "Q2 budgets allocated to departments",
    agentId: AGENT_IDS.coo,
    metadata: { total: 77000 },
    createdAt: daysAgo(0),
  },
  ...
  },
  {
    ...
    message: "Critical bug found in task transitions",
    agentId: AGENT_IDS.qaEngineer,
    createdAt: hoursAgo(6),
  },
  {
    ...
    type: "task.started",
    severity: EventSeverity.INFO,
    message: "Launch copy in progress",
    agentId: AGENT_IDS.contentWriter,
    taskId: "task-nt-014",
    createdAt: hoursAgo(4),
  },
