  ...
  definitions: [
    {
      ...
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "AgentType" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          ...
          { kind: "Field", name: { kind: "Name", value: "budgetPeriodLimit" } },
          { kind: "Field", name: { kind: "Name", value: "budgetPeriodSpent" } },
          { kind: "Field", name: { kind: "Name", value: "managementFeePct" } },
          { kind: "Field", name: { kind: "Name", value: "parentId" } },
          { kind: "Field", name: { kind: "Name", value: "createdAt" } },
          { kind: "Field", name: { kind: "Name", value: "updatedAt" } },
          { kind: "Field", name: { kind: "Name", value: "trustScore" } },
          { kind: "Field", name: { kind: "Name", value: "reputationLevel" } },
          { kind: "Field", name: { kind: "Name", value: "tasksCompleted" } },
          { kind: "Field", name: { kind: "Name", value: "tasksSuccessful" } },
          { kind: "Field", name: { kind: "Name", value: "lastActivityAt" } },
          { kind: "Field", name: { kind: "Name", value: "lastPromotionAt" } },
          { kind: "Field", name: { kind: "Name", value: "lifetimeEarnings" } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "approvalRequired" } },
                ...
                { kind: "Field", name: { kind: "Name", value: "approvedAt" } },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "rejectionCount" } },
                    ],
                  },
                },
              ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "FragmentSpread", name: { kind: "Name", value: "AgentFields" } },
              ],
            },
          },
        ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "balanceAfter" } },
                { kind: "Field", name: { kind: "Name", value: "reason" } },
                { kind: "Field", name: { kind: "Name", value: "triggerType" } },
                { kind: "Field", name: { kind: "Name", value: "sourceTaskId" } },
                { kind: "Field", name: { kind: "Name", value: "createdAt" } },
              ],
            },
          },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "hookType" } },
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "CreateWebhookInput" } },
          },
        },
      ],
      selectionSet: {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "UpdateWebhookInput" } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<TestWebhookMutation, TestWebhookMutationVariables>;
