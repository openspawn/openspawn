...
export const AVATAR_STYLES = {
  ...
  pixelArtNeutral: {
    ...
    name: "Pixel Neutral",
    description: "Neutral pixel characters",
  },
  ...
  loreleiNeutral: {
    ...
    description: "Neutral illustrated portraits",
  },
...
export const BACKGROUND_COLORS = {
  levelBased: {
    name: "Level-Based",
    description: "Colors based on agent level (pink→purple→cyan→yellow→gray)",
    colors: null,
  },
  purple: {
    name: "Purple",
...
): import("@dicebear/core").Style<Record<string, unknown>> {
