...
try {
  ...
  `, [
    org.id, 'talent', 'Talent Agent', 10, 'opus', 'active', 'hr',
    20, 0, 0, encryptedSecret,
  ...
  `, [
    org.id, 'agent.registered', agent.id, 'agent', agent.id,
    JSON.stringify({ agentId: 'talent', name: 'Talent Agent', role: 'hr', level: 10 }),
    'info', 'Initial seed - Talent Agent self-registration'
  ]);
