...
async function seed() {
  ...
  // Create tasks
  const tasks = [
    { title: 'Python SDK development', description: 'Complete pip-installable SDK', status: 'done', priority: 'high', assigneeAgentId: 'dennis' },
    { title: 'npm CLI polish', description: 'Add preview, fix version', status: 'done', priority: 'high', assigneeAgentId: 'dennis' },
    { title: 'External review fixes', description: 'Address Claude assessment', status: 'done', priority: 'critical', assigneeAgentId: 'dennis' },
    { title: 'Team dashboard live view', description: 'Wire team.openspawn.ai', status: 'in_progress', priority: 'critical', assigneeAgentId: 'dennis' },
  ];
