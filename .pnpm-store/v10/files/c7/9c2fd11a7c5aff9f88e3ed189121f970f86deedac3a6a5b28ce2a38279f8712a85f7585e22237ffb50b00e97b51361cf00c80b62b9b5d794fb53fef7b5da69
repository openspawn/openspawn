 ...
 */
function getPackageJson(packagePath, relativePath) {
  const packageJsonPath = _nodePath.default.join(packagePath, relativePath, 'package.json');
  return JSON.parse(_nodeFs.default.readFileSync(packageJsonPath, 'utf8'));
}
