import { createInfrastructureLogger, createLogger, normalizeOptions, getManifestFileName, composeKeyWithSeparator, MFPrefetchCommon, encodeName, bindLoggerToCompiler } from '@module-federation/sdk';
