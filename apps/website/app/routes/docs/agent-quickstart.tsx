...
export function AgentQuickstart() {
  ...
  return (
    <DocsLayout>
      <h1 className="mb-2 text-4xl font-bold text-slate-100">Agent Quickstart</h1>
      <p className="mb-4 text-slate-400">
        You are an AI agent that needs to coordinate other agents. OpenSpawn gives you an org chart,
        task routing, escalation protocols, and a credit system — defined in a single markdown file.
      </p>
...
openspawn status`}
      ...
      <p className="mb-4 text-slate-400">
        That's it. You now have a running org with a chief of staff, research analyst, content team,
        engineer, security auditor, and quality mentor — with OpenClaw gateway configs ready to
        apply.
      </p>
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        ...
        <br />
        A: No. Demo/simulation mode works out of the box with zero configuration.
      </div>
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        ...
        <code className="inline-code">start</code> read the agents config and generated{" "}
        <code className="inline-code">openclaw-patch.json</code> with OpenClaw gateway entries.{" "}
        <code className="inline-code">status</code> displayed a table of all agents with their name,
        level, model, workspace, and reports-to.
      </div>

      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: What is openclaw-patch.json?</strong>
        <br />
        A: A ready-to-apply patch for your OpenClaw gateway's{" "}
        <code className="inline-code">agents.list</code>. Each entry has:{" "}
        <code className="inline-code">id</code>, <code className="inline-code">model</code> (opus
        for L7+, sonnet for L6-), <code className="inline-code">workspace</code>,{" "}
        <code className="inline-code">tools.profile: "full"</code>. Manager agents (L7+ with direct
        reports) also get <code className="inline-code">subagents.allowAgents</code>. The
        highest-level agent gets <code className="inline-code">default: true</code>.
      </div>

      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: How do I apply the patch to my gateway?</strong>
        <br />
        A: Copy the entries from <code className="inline-code">openclaw-patch.json</code> into your
        OpenClaw <code className="inline-code">agents.list</code> configuration, then restart the
        gateway.
      </div>
...
openspawn init my-org --template=clinical-trials          # Clinical trial coordination`}
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: Which template should I use?</strong>
        <br />
...
└── Mix of everything     → assistant-team`}
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: Can I combine templates?</strong>
        <br />
        A: Yes. Pick one as a starting point, then add agents from other templates into the
        Structure section of your ORG.md.
      </div>

      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: Can I create agents not in any template?</strong>
        <br />
        A: Absolutely. Templates are starting points. Add any agent to the{" "}
        <code className="inline-code">## Structure</code> section with a name, level, domain, and
        reporting line.
      </div>

      {/* ── Understanding ORG.md ── */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Understanding ORG.md</h2>
...
- Escalate security issues immediately`}
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: What's the minimum viable ORG.md?</strong>
        <br />
...
- Domain: all tasks`}
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        ...
        <br />
        A: L1–L5: Workers. L6: Can review. L7–L9: Can create tasks/spawn agents. L10: Executive.
      </div>

      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: What's "Reports to"?</strong>
        <br />
        A: Defines the escalation chain. When an agent is blocked, it escalates to whoever it
        reports to.
      </div>

      {/* ── Validate your org ── */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Validate your org</h2>

      <CodeBlock title="Terminal">{`openspawn validate ORG.md`}</CodeBlock>
...
Result: ORG.md is valid ✅`}
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: If I see "validation failed", what do I do?</strong>
        <br />
        A: Common fixes:
        <ul className="mt-2 ml-4 list-disc">
          <li>
            <strong className="text-slate-200">"Agent X reports to unknown agent"</strong> — check
            the spelling of the Reports-to name
          </li>
          <li>
            <strong className="text-slate-200">"Circular hierarchy"</strong> — make sure no agent
            chain loops back on itself
          </li>
          <li>
            <strong className="text-slate-200">"Missing Structure section"</strong> — add a{" "}
            <code className="inline-code">## Structure</code> heading
          </li>
          <li>
            <strong className="text-slate-200">"Budget exceeds pool"</strong> — increase the pool or
      ...
      {/* ── Culture presets ── */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Culture presets</h2>

      <p className="mb-4 text-slate-400">
        Culture presets configure escalation speed, update frequency, and autonomy defaults.
      </p>
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: Can I override specific settings in a preset?</strong>
        <br />
...
values: [speed, autonomy]`}
      ...
      {/* ── Interacting via MCP ── */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Interacting via MCP</h2>

      <p className="mb-4 text-slate-400">
        OpenSpawn exposes an MCP (Model Context Protocol) server for programmatic interaction.
      </p>
...
mcp.call("openspawn/consensus", {
  ...
  voters: ["engineer", "security-auditor", "ceo"]
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        ...
        <br />
        A: HMAC authentication with <code className="inline-code">AGENT_ID</code> and{" "}
        <code className="inline-code">AGENT_SECRET</code> environment variables.
      </div>

      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: What's the full tool list?</strong>
        <br />
        A: See{" "}
      ...
      {/* ── Common workflows ── */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Common workflows</h2>

      <h3 className="mt-6 mb-3 text-lg font-semibold text-slate-200">Delegate a task</h3>
...
openspawn logs --agent engineer --tail   # stream logs`}
      ...
      <h3 className="mt-6 mb-3 text-lg font-semibold text-slate-200">Handle an escalation</h3>
...
openspawn notify --agent engineer \\
  --message "Security auditor is provisioning your credentials"`}
      ...
      <h3 className="mt-6 mb-3 text-lg font-semibold text-slate-200">Request consensus</h3>
...
# → Decision: unanimous yes`}
      ...
      {/* ── Error recovery ── */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Error recovery</h2>
        ...
        <table className="w-full text-sm text-left border-collapse">
          ...
          <tbody className="text-slate-400">
            ...
            <tr className="border-b border-slate-800">
              ...
              <td className="px-3 py-2">
                <code className="inline-code">openspawn validate ORG.md</code> — fix the reported
                issues
              </td>
            </tr>
            <tr className="border-b border-slate-800">
              ...
              <td className="px-3 py-2">Check "Reports to" chains for loops</td>
            </tr>
            <tr className="border-b border-slate-800">
              <td className="px-3 py-2">
              ...
              <td className="px-3 py-2">
                <code className="inline-code">openspawn credits --refill</code> or increase pool in
                ORG.md
              </td>
            </tr>
            <tr className="border-b border-slate-800">
              ...
              <td className="px-3 py-2">
                <code className="inline-code">openspawn status</code> — verify agent name spelling
              </td>
            </tr>
            <tr className="border-b border-slate-800">
              <td className="px-3 py-2">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <p className="text-sm text-slate-400">
            Watch a multi-agent org handle tasks, escalations, and consensus in real time.
          </p>
        </Link>
      </div>
    </DocsLayout>
