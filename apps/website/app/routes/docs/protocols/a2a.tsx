...
export function A2AProtocol() {
  ...
  return (
    <DocsLayout>
      ...
      <p className="mb-8 text-lg text-slate-400">
        OpenSpawn implements Google's Agent-to-Agent protocol v0.3 for agent discovery, task
      ...
      <p className="mb-4 text-slate-400">
        Every OpenSpawn instance publishes an Agent Card at{" "}
        <code className="inline-code">/.well-known/agent.json</code>:
      </p>
  ...
  "skills": [
    ...
    { "id": "agent-coordination", "name": "Agent Coordination" }
      ...
      <p className="mb-4 text-slate-400">
        Each agent has its own card at{" "}
  ...
  -d '{
    "message": {
      ...
      <p className="mb-4 text-slate-400">
        Use <code className="inline-code">/a2a/message/stream</code> for SSE streaming of task
