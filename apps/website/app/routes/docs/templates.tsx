...
export function TemplatesGuide() {
  ...
  return (
    <DocsLayout>
      <h1 className="mb-2 text-4xl font-bold text-slate-100">Templates Guide</h1>
      <p className="mb-4 text-slate-400">
        OpenSpawn ships four org templates. Each produces a complete, ready-to-run{" "}
        <code className="inline-code">ORG.md</code> with roles, hierarchy, culture, policies, and
        playbooks.
      </p>

      {/* Which template should I use? */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Which template should I use?</h2>
...
└── None of these fit → Start with assistant-team, then customize`}
      ...
      {/* Comparison table */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Comparison table</h2>
      ...
      <div className="mb-8 overflow-x-auto">
        <table className="w-full text-sm text-left border-collapse">
          ...
          <tbody className="text-slate-400">
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Culture preset</strong>
              </td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Agent count</strong>
              </td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Hierarchy depth</strong>
              </td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Top role</strong>
              </td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Domains</strong>
              </td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Autonomy</strong>
              </td>
      ...
      {/* assistant-team */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">assistant-team</h2>
      <p className="mb-4 text-slate-400">
      ...
      <div className="mb-8 overflow-x-auto">
        <table className="w-full text-sm text-left border-collapse">
          ...
          <tbody className="text-slate-400">
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Oscar</strong>
              </td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Radar</strong>
              </td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Muse</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Ink</strong>
              </td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Lens</strong>
              </td>
              <td className="py-2 pr-6">L4</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Forge</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Shield</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Guru</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
...
autonomy: medium`}
      ...
      {/* content-agency */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">content-agency</h2>
      <p className="mb-4 text-slate-400">
      ...
      <div className="mb-8 overflow-x-auto">
        <table className="w-full text-sm text-left border-collapse">
          ...
          <tbody className="text-slate-400">
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Researcher</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
              <td className="py-2 pr-6">Research</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Strategist</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Writer</strong>
              </td>
              <td className="py-2 pr-6">L4</td>
              <td className="py-2 pr-6">Writing</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Designer</strong>
              </td>
              <td className="py-2 pr-6">L4</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Editor</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
              <td className="py-2 pr-6">Quality</td>
              <td className="py-2 pr-6">Director</td>
      ...
      <p className="mb-4 text-slate-400">
        <strong className="text-slate-200">When to use:</strong> primary output is content, want a
        clear pipeline, quality over speed.
      </p>

      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        <strong className="text-slate-200">Q: What about SEO?</strong>
        <br />
        A: Add an SEO agent under Strategist, L4, domain <code className="inline-code">"SEO"</code>.
      </div>

      {/* dev-shop */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">dev-shop</h2>
      <p className="mb-4 text-slate-400">
      ...
      <div className="mb-8 overflow-x-auto">
        <table className="w-full text-sm text-left border-collapse">
          ...
          <tbody className="text-slate-400">
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Lead</strong>
              </td>
              <td className="py-2 pr-6">L10</td>
              <td className="py-2 pr-6">Engineering</td>
            </tr>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">QA</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">DevOps</strong>
              </td>
              <td className="py-2 pr-6">L4</td>
      ...
      <div className="mb-4 rounded-lg border border-cyan-500/20 bg-cyan-500/5 px-4 py-3 text-sm text-cyan-300">
        ...
        <br />
        A: Add a Designer agent or combine with <code className="inline-code">assistant-team</code>.
      </div>

      {/* research-lab */}
      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">research-lab</h2>
      <p className="mb-4 text-slate-400">
      ...
      <div className="mb-8 overflow-x-auto">
        <table className="w-full text-sm text-left border-collapse">
          ...
          <tbody className="text-slate-400">
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Analyst</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Explorer</strong>
              </td>
              <td className="py-2 pr-6">L7</td>
            ...
            <tr className="border-b border-white/5">
              <td className="py-2 pr-6">
                <strong className="text-slate-200">Synthesizer</strong>
              </td>
              <td className="py-2 pr-6">L4</td>
...
- Oscar L10 Operations
  ...
  - NewAgent L7 Analytics    # ← add a new line under the parent`}
      ...
      <p className="mb-4 text-slate-400">
        Move agent lines to different indentation levels or under different parents. Validate after
        changes.
      </p>

      <h3 className="mt-8 mb-3 text-xl font-bold text-slate-100">Change culture</h3>
      <p className="mb-4 text-slate-400">
        Edit the <code className="inline-code">preset</code> value in the Culture section. Valid
        presets: <code className="inline-code">agency</code>,{" "}
        <code className="inline-code">startup</code>, <code className="inline-code">research</code>.
      </p>

      <h3 className="mt-8 mb-3 text-xl font-bold text-slate-100">Add a playbook</h3>
      <p className="mb-4 text-slate-400">
        Add a new section under Playbooks in your <code className="inline-code">ORG.md</code> with
        step-by-step instructions for recurring workflows.
      </p>
