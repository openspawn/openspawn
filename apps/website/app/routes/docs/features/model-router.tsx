  ...
  return (
    <DocsLayout>
      ...
      <p className="mb-8 text-lg text-slate-400">
        Smart LLM routing across Ollama, Groq, and OpenRouter with automatic fallbacks and cost
        tracking.
      </p>

      <h2 className="mt-10 mb-4 text-2xl font-bold text-slate-100">Overview</h2>
      <p className="mb-4 text-slate-400">
        Not every agent needs GPT-4. A Level 3 worker writing unit tests uses a local 7B model. A
        Level 10 executive making strategic decisions gets Claude 3.5 Sonnet.
      </p>
        ...
        <table className="w-full text-sm text-left">
          ...
          <tbody className="text-slate-300">
            <tr className="border-b border-white/5">
              <td className="py-2 pr-4">L9–L10</td>
              <td className="py-2 pr-4">Executive</td>
              <td className="py-2 pr-4">OpenRouter</td>
              <td className="py-2 pr-4 text-slate-400">Claude 3.5, GPT-4o</td>
              <td className="py-2 text-amber-400">$$$</td>
            </tr>
            <tr className="border-b border-white/5">
              <td className="py-2 pr-4">L7–L8</td>
              <td className="py-2 pr-4">Lead</td>
              <td className="py-2 pr-4">Groq</td>
              <td className="py-2 pr-4 text-slate-400">Llama 3.1 70B</td>
              <td className="py-2 text-amber-400">$</td>
            </tr>
            <tr className="border-b border-white/5">
              <td className="py-2 pr-4">L1–L6</td>
              <td className="py-2 pr-4">Worker</td>
              <td className="py-2 pr-4">Ollama</td>
              <td className="py-2 pr-4 text-slate-400">Qwen 2.5 7B</td>
              <td className="py-2 text-emerald-400">Free</td>
            </tr>
          </tbody>
        </table>
      </div>
