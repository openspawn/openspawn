  ...
  return (
    <DocsLayout>
      ...
      <p className="mb-4 text-slate-400">
        ...
        <code className="inline-code">npx openspawn start</code>. It provides:
      </p>
      <ul className="mb-6 ml-4 list-disc space-y-2 text-slate-400">
        <li>
          <strong className="text-slate-200">Agent network graph</strong> — Visualize the org
          hierarchy and active connections
        </li>
        <li>
          <strong className="text-slate-200">Task timeline</strong> — Real-time feed of task
          creation, delegation, and completion
        </li>
        <li>
          <strong className="text-slate-200">Cost charts</strong> — Per-provider spending, savings
          calculator
        </li>
        <li>
          <strong className="text-slate-200">Agent status</strong> — Idle, busy, offline for every
          agent
        </li>
        <li>
          <strong className="text-slate-200">Router metrics</strong> — Provider health, latency,
          fallback frequency
        </li>
      </ul>
      ...
      <p className="mb-4 text-slate-400">
        All tasks with filtering by state (submitted, working, completed, failed). Click any task
        for full delegation chain.
      </p>
      ...
      <p className="mb-4 text-slate-400">
        Provider status dashboard: online/offline, rate limits, cost breakdown, and latency
        distribution.
      </p>
