        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              ...
              <li>
                <a href="/docs/getting-started" className="hover:text-cyan-400 transition">
                  Getting Started
                </a>
              </li>
              <li>
                <a href="/docs/protocols/a2a" className="hover:text-cyan-400 transition">
                  A2A Protocol
                </a>
              </li>
              <li>
                <a href="/docs/protocols/mcp" className="hover:text-cyan-400 transition">
                  MCP Tools
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-500">
              <li>
                <a href="/docs/features/model-router" className="hover:text-cyan-400 transition">
                  Model Router
                </a>
              </li>
              <li>
                <a href="/docs/features/dashboard" className="hover:text-cyan-400 transition">
                  Live Dashboard
                </a>
              </li>
              <li>
                <a href="/org-md" className="hover:text-cyan-400 transition">
                  ORG.md
                </a>
              </li>
            </ul>
