...
export function OrgMdIllustration({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      {/* Markdown heading # */}
      <text x="8" y="20" fontSize="8" fill="#22d3ee" fontFamily="monospace" fontWeight="800">
        # Org
      </text>
      {/* ## Teams */}
      <text x="8" y="30" fontSize="6.5" fill="#a78bfa" fontFamily="monospace" fontWeight="700">
        ## Teams
      </text>
      {/* - list items */}
      <text x="8" y="38" fontSize="5.5" fill="#94a3b8" fontFamily="monospace">
        - 🔬 Research
      </text>
      <text x="8" y="45" fontSize="5.5" fill="#94a3b8" fontFamily="monospace">
        - 🛠 Engineering
      </text>
      {/* ## Policies */}
      <text x="8" y="53" fontSize="6" fill="#a78bfa" fontFamily="monospace" fontWeight="700">
        ## Policies
      </text>
      ...
      />
      {/* Small label */}
      <text x="49.5" y="28" textAnchor="middle" fontSize="5" fill="#22d3ee" fontFamily="monospace">
        parse
      </text>
      ...
      <rect
        ...
        strokeWidth="0.8"
      />
      <text x="66" y="58" textAnchor="middle" fontSize="5" fill="#64748b" fontFamily="monospace">
        Scout
      </text>
      ...
      <text x="7" y="96" fontSize="5" fill="#10b981" fontFamily="monospace" opacity="0.7">
