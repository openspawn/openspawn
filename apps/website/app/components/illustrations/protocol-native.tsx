    ...
    >
      ...
      {[
        ...
        <g key={`${agent.label}-${agent.y}`}>
          ...
          />
          {/* Status dot */}
          <circle cx="7" cy={agent.y + 5} r="2" fill={agent.active ? "#a78bfa" : "#334155"}>
            {agent.active && (
          ...
          <text
            ...
            textAnchor="middle"
            fontSize="5"
            fill={agent.active ? "#a78bfa" : "#475569"}
            fontFamily="monospace"
          >
            {agent.label}
          </text>
      ...
      <text x="50" y="35" textAnchor="middle" fontSize="5" fill="#64748b" fontFamily="monospace">
        Protocol
      </text>
      ...
      <text x="50" y="79" textAnchor="middle" fontSize="5" fill="#64748b" fontFamily="monospace">
        7 tools
      </text>
      ...
      <rect
        ...
        strokeWidth="0.6"
      />
      <text x="18" y="77" textAnchor="middle" fontSize="4" fill="#64748b" fontFamily="monospace">
        .well-known/
      </text>
      <text x="18" y="83" textAnchor="middle" fontSize="4" fill="#22d3ee" fontFamily="monospace">
        agent.json
      </text>
      <text x="18" y="88" textAnchor="middle" fontSize="3.5" fill="#475569" fontFamily="monospace">
        auto-published
      </text>
