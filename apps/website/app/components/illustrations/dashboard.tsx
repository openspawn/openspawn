...
export function DashboardIllustration({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <text x="8" y="25.5" fontSize="4.5" fill="#64748b" fontFamily="monospace">
        Health
      </text>
      ...
      <text x="30" y="25.5" fontSize="4" fill="#22d3ee" fontFamily="monospace" fontWeight="700">
        82%
      </text>
      <text x="82" y="25.5" fontSize="4.5" fill="#34d399" fontFamily="monospace" fontWeight="700">
        ● HEALTHY
      </text>
      ...
      <rect
        ...
        strokeWidth="0.5"
      />
      <text x="28" y="38" textAnchor="middle" fontSize="4.5" fill="#64748b" fontFamily="monospace">
        Network
      </text>
      ...
      <rect
        ...
        strokeWidth="0.5"
      />
      <text x="74" y="38" textAnchor="middle" fontSize="4.5" fill="#64748b" fontFamily="monospace">
        Tasks
      </text>
