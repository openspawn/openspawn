...
const SCENARIOS: {
...
}[] = [
  {
    ...
    description:
      "Deep dive into a full product launch — 22 agents navigating the depths from discovery to deployment",
                ...
                >
                  ...
                  <div className="p-6 pb-4 border-b border-border">
                    ...
                    <p className="text-muted-foreground text-sm mt-1">
                      Each scenario simulates a different sized organization with live agent
                      activity.
                    </p>
                  </div>
                      ...
                      {SCENARIOS.map((scenario) => (
                        ...
                        >
                          <div className="flex items-start gap-3">
                            <div
                              className={`w-10 h-10 rounded-lg bg-gradient-to-br ${scenario.color} flex items-center justify-center text-white shrink-0`}
                            >
                              {scenario.icon}
                            </div>
