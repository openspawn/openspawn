...
const IDLE_REASON_CONFIG: Record<
  IdleReason,
  {
          ...
          <AnimatePresence mode="popLayout">
            {idleAgents.map((idleInfo) => (
              <div
                ...
                className="flex-shrink-0 w-[260px] snap-start sm:w-full sm:flex-shrink"
              >
                <IdleAgentCard idleInfo={idleInfo} onClick={() => onAgentClick?.(idleInfo.agent)} />
              </div>
            ))}
          </AnimatePresence>
        </div>
