...
export const AGENT_ROSTER: AgentCharacter[] = [
  ...
  },
  {
    ...
    accentColor: '#1E8449',
    status: 'busy',
    lastMessage: 'All I wanted was the secret formula. Now I have 10,000 patties. This was not the plan.',
  },
  {
    id: 'mrs-puff',
    name: 'Mrs. Puff',
...
export const SAMPLE_TICKER_MESSAGES = [
  { id: 't1', agentEmoji: '🦀', agentName: 'Mr. Krabs', text: 'COOK FASTER BOY — Plankton wants 10,000!', type: 'delegation' as const },
  { id: 't2', agentEmoji: '🧽', agentName: 'SpongeBob', text: 'Batch 47 started — 500 patties incoming', type: 'message' as const },
  { id: 't3', agentEmoji: '🐙', agentName: 'Squidward', text: 'I CANNOT deliver 200 batches alone', type: 'escalation' as const },
  { id: 't4', agentEmoji: '🦀', agentName: 'Mr. Krabs', text: 'Then get help. Fred-1, Fred-2, Fred-3 — hired.', type: 'delegation' as const },
  { id: 't5', agentEmoji: '📦', agentName: 'System', text: 'Delivery rate ↑ 340% — Fred-1/2/3 joined team', type: 'completion' as const },
  { id: 't6', agentEmoji: '🐡', agentName: 'Bubble Bass', text: 'You forgot the pickles. BATCH 46 REJECTED.', type: 'escalation' as const },
  { id: 't7', agentEmoji: '🧽', agentName: 'SpongeBob', text: 'Sorry! Adding pickles. Batch 46r in progress.', type: 'message' as const },
  { id: 't8', agentEmoji: '🐿️', agentName: 'Sandy', text: 'Spatula algorithm upgraded. Throughput +15%!', type: 'completion' as const },
  { id: 't9', agentEmoji: '⭐', agentName: 'Patrick', text: 'Is mayonnaise a patty? I made 200 somehow.', type: 'message' as const },
  { id: 't10', agentEmoji: '🦞', agentName: 'Larry', text: 'Batch 32 delivered. Arms are pumped. 💪', type: 'completion' as const },
];
