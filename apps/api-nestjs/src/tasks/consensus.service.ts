...
import { ConsensusStatus, ConsensusType, EventSeverity, VoteValue } from "@openspawn/shared-types";
...
export class ConsensusService {
  ...
  private async checkAndFinalizeRequest(request: ConsensusRequest): Promise<void> {
    ...
    await this.eventsService.emit({
      ...
      entityId: request.id,
      severity:
        request.status === ConsensusStatus.APPROVED ? EventSeverity.INFO : EventSeverity.WARNING,
      data: {
