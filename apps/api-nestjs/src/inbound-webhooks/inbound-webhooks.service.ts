...
export class InboundWebhooksService {
   ...
   */
  async create(orgId: string, dto: CreateInboundWebhookKeyDto): Promise<InboundWebhookKey> {
  ...
  async update(
    ...
    if (dto.defaultAgentId !== undefined) webhookKey.defaultAgentId = dto.defaultAgentId;
    if (dto.defaultPriority !== undefined) webhookKey.defaultPriority = dto.defaultPriority;
