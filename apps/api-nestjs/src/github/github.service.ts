...
export class GitHubService implements IntegrationProvider {
  ...
  private async handlePullRequestEvent(orgId: string, payload: Record<string, any>): Promise<void> {
  ...
  private async handleCheckSuiteEvent(orgId: string, payload: Record<string, any>): Promise<void> {
