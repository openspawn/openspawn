...
type TaskLifecyclePhase = "created" | "assigned" | "in_progress" | "completed" | "failed";
...
export class TelemetryService {
  ...
  recordTaskLifecycle(taskId: string, phase: TaskLifecyclePhase, agentId?: string): TraceSpan {
