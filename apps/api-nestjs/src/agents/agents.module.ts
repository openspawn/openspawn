...
import { Agent, AgentCapability, CreditTransaction, ReputationEvent } from "@openspawn/database";
...
@Module({
  imports: [
    TypeOrmModule.forFeature([Agent, AgentCapability, CreditTransaction, ReputationEvent]),
    EventsModule,
  ],
