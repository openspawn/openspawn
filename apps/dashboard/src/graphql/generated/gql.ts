...
const documents: Documents = {
    "\n  query InboundWebhookKeys($orgId: ID!) {\n    inboundWebhookKeys(orgId: $orgId) {\n      id\n      name\n      key\n      secret\n      defaultAgentId\n      defaultPriority\n      defaultTags\n      enabled\n      lastUsedAt\n      createdAt\n      updatedAt\n    }\n  }\n": types.InboundWebhookKeysDocument,
    "\n  query AgentsForWebhook($orgId: ID!) {\n    agents(orgId: $orgId) {\n      id\n      name\n      agentId\n      status\n    }\n  }\n": types.AgentsForWebhookDocument,
    "\n  mutation CreateInboundWebhookKey($orgId: ID!, $input: CreateInboundWebhookKeyInput!) {\n    createInboundWebhookKey(orgId: $orgId, input: $input) {\n      id\n      name\n      key\n      secret\n      defaultAgentId\n      defaultPriority\n      defaultTags\n      enabled\n      lastUsedAt\n      createdAt\n      updatedAt\n    }\n  }\n": types.CreateInboundWebhookKeyDocument,
    "\n  mutation UpdateInboundWebhookKey($orgId: ID!, $id: ID!, $input: UpdateInboundWebhookKeyInput!) {\n    updateInboundWebhookKey(orgId: $orgId, id: $id, input: $input) {\n      id\n      name\n      key\n      secret\n      defaultAgentId\n      defaultPriority\n      defaultTags\n      enabled\n      lastUsedAt\n      createdAt\n      updatedAt\n    }\n  }\n": types.UpdateInboundWebhookKeyDocument,
    "\n  mutation RotateInboundWebhookKey($orgId: ID!, $id: ID!) {\n    rotateInboundWebhookKey(orgId: $orgId, id: $id) {\n      id\n      name\n      key\n      secret\n      defaultAgentId\n      defaultPriority\n      defaultTags\n      enabled\n      lastUsedAt\n      createdAt\n      updatedAt\n    }\n  }\n": types.RotateInboundWebhookKeyDocument,
    "\n  mutation DeleteInboundWebhookKey($orgId: ID!, $id: ID!) {\n    deleteInboundWebhookKey(orgId: $orgId, id: $id)\n  }\n": types.DeleteInboundWebhookKeyDocument,
