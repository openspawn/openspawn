          ...
          <motion.div key={key} layout>
            ...
            >
              ...
              <CardContent className="p-3 md:p-4 pt-0">
                {!isExpanded ? (
                  <p className="text-xs md:text-sm text-muted-foreground line-clamp-2">{latestMsg.content}</p>
                ) : (
                  <>
                      ...
                      <div className="space-y-2">
                        {[...msgs]
                          ...
                          .map((msg) => {
                            ...
                            const renderer   = acpType && isSandboxMode ? acpTypeRenderers[acpType] : undefined;
                            ...
                            return (
                              <div key={msg.id} className={cn("flex gap-2", isAgent1 ? "flex-row" : "flex-row-reverse")}>
                                ...
                                <div
                                  className={cn(
                                    ...
                                    acpResult ? acpResult.className : (isAgent1 ? "bg-muted" : "bg-primary/10"),
                                  )}
                                >
