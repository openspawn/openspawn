...
export const TIMELINE: ReplayEvent[] = [
  ...
  { tick: 19, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-1', name: 'Sous Chef #1', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  ...
  { tick: 19, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-2', name: 'Sous Chef #2', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 20, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-3', name: 'Sous Chef #3', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 20, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-4', name: 'Sous Chef #4', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  ...
  { tick: 21, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-5', name: 'Sous Chef #5', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 21, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-6', name: 'Sous Chef #6', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 21, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-7', name: 'Sous Chef #7', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 22, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-8', name: 'Sous Chef #8', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 22, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-9', name: 'Sous Chef #9', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 22, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-10', name: 'Sous Chef #10', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  ...
  { tick: 23, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-11', name: 'Sous Chef #11', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 23, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-12', name: 'Sous Chef #12', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 23, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-13', name: 'Sous Chef #13', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 24, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-14', name: 'Sous Chef #14', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 24, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-15', name: 'Sous Chef #15', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 24, type: 'stat_update', data: { stats: { kitchenRate: 65, pattiesProduced: 400, queueSize: 250, revenue: 1000, budgetUsed: 15 } } },
  { tick: 25, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-16', name: 'Sous Chef #16', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 25, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-17', name: 'Sous Chef #17', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 25, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-18', name: 'Sous Chef #18', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 26, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-19', name: 'Sous Chef #19', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
  { tick: 26, type: 'spawn', data: { spawnAgent: { id: 'sous-chef-20', name: 'Sous Chef #20', emoji: '⭐', avatarUrl: '/app/avatars/patrick.png', parentId: 'spongebob-squarepants' }} },
