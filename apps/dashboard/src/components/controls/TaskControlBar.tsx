...
function HireModal({ onHire, onClose }: { onHire: TaskControlBarProps['onHire']; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" style={{ animation: 'fade-in 0.15s ease-out' }}>
      ...
      >
        <div className="text-base font-bold mb-4" style={{ color: '#4AAED9', fontFamily: '"Baloo 2", cursive' }}>
          🐟 Hire New Agent
        </div>

        <div className="space-y-3">
          <div>
            <label className="block text-[11px] font-semibold mb-1" style={{ color: 'rgba(184,228,247,0.5)', fontFamily: 'Nunito, sans-serif' }}>
              ROLE NAME
            </label>
            <input
              value={role}
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" style={{ animation: 'fade-in 0.15s ease-out' }}>
      ...
      >
        <div className="flex items-center justify-between p-4 border-b border-[rgba(74,174,217,0.12)]">
          <div className="text-base font-bold" style={{ color: '#F4C542', fontFamily: '"Baloo 2", cursive' }}>
            📋 PLAN.md
          </div>
          <button onClick={onClose} className="text-[rgba(184,228,247,0.4)] hover:text-[#B8E4F7] transition-colors">✕</button>
        </div>
        <div className="flex-1 overflow-y-auto p-4">
          <pre className="text-xs whitespace-pre-wrap" style={{ color: '#B8E4F7', fontFamily: 'Nunito, sans-serif', lineHeight: 1.6 }}>
