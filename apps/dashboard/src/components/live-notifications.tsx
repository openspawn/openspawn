...
const demoNotifications: Omit<Notification, "id" | "timestamp" | "read">[] = [
  {
    ...
    description: "Code Wizard has joined the network and is ready for tasks.",
  },
  {
    type: "task",
    title: "Task Completed",
    description: "API-001 finished successfully by Code Wizard in 3m 42s.",
  },
  {
    type: "message",
    title: "New Direct Message",
    description: "Talent Agent sent you a message about the deployment.",
  },
  {
    type: "credit",
    title: "Low Balance Warning",
    description: "Your credit balance is below 500. Consider topping up.",
  },
  {
    type: "system",
    title: "System Maintenance",
    description: "Scheduled maintenance window tonight at 2:00 AM UTC.",
  },
  {
    type: "agent",
    title: "Agent Status Change",
    description: "Research Bot went idle after completing 12 tasks.",
  },
  {
    type: "task",
    title: "Task Failed",
    description: "DOC-042 failed with exit code 1. Check logs for details.",
  },
  {
    type: "message",
    title: "Mention in #general",
    description: "Content Crafter mentioned you in the general channel.",
  },
  {
    type: "credit",
    title: "Credits Earned",
    description: "+500 credits awarded for completing the API integration sprint.",
  },
  {
    type: "system",
    title: "Rate Limit Warning",
    description: "Agent Code Wizard approaching API rate limit (85% used).",
  },
];
