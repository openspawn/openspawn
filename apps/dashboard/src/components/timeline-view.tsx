...
export function generateMockTimeline(agentId: string): TimelineEvent[] {
  ...
  return [
    ...
    },
    {
      id: "e2",
      type: "task_assigned",
      title: "Task #42 assigned",
      description: "Assigned to agent for execution",
      timestamp: m(3),
      agentId,
      taskId: "t42",
    },
    {
      ...
      description: "Picked up task #42, analyzing requirements",
      timestamp: m(5),
      agentId,
      taskId: "t42",
    },
    {
      ...
      description: '"Starting implementation of auth module"',
      timestamp: m(12),
      agentId,
      taskId: "t42",
    },
    {
      ...
      description: "2.5 credits for GPT-4 inference",
      timestamp: m(18),
      agentId,
      taskId: "t42",
    },
    {
      ...
      description: "Submitted PR #187 for review",
      timestamp: m(35),
      agentId,
      taskId: "t42",
    },
    {
      ...
      type: "credit_transaction",
      title: "Credits consumed",
      description: "1.8 credits for Claude inference",
      timestamp: m(40),
      agentId,
      taskId: "t42",
    },
    {
      ...
      description: "Auth flow implemented and tested",
      timestamp: m(55),
      agentId,
      taskId: "t42",
    },
    ...
    },
    {
      id: "e10",
      type: "task_assigned",
      title: "Task #43 assigned",
      description: "Auto-assigned based on capability match",
      timestamp: m(62),
      agentId,
      taskId: "t43",
    },
    {
      ...
      type: "agent_started",
      title: "Agent started working",
      description: "Analyzing existing endpoints for docs",
      timestamp: m(64),
      agentId,
      taskId: "t43",
    },
    {
      id: "e12",
      type: "task_created",
      title: "Task #44 created",
      description: "Fix pagination bug in list view",
      timestamp: m(70),
      agentId,
      taskId: "t44",
    },
    {
      ...
      description: '"Documented 8/12 endpoints so far"',
      timestamp: m(90),
      agentId,
      taskId: "t43",
    },
    {
      ...
      description: "Urgent bug fix assignment",
      timestamp: m(95),
      agentId,
      taskId: "t44",
    },
    {
      ...
      type: "credit_transaction",
      title: "Credits consumed",
      description: "3.2 credits for multi-model pipeline",
      timestamp: m(110),
      agentId,
      taskId: "t43",
    },
    {
      id: "e16",
      type: "agent_started",
      title: "Agent started on #44",
      description: "Investigating pagination offset issue",
      timestamp: m(115),
      agentId,
      taskId: "t44",
    },
    {
      id: "e17",
      type: "task_failed",
      title: "Task #44 failed",
      description: "Could not reproduce bug in test env",
      timestamp: m(140),
      agentId,
      taskId: "t44",
    },
    {
      ...
      description: '"All 12 endpoints documented with examples"',
      timestamp: m(160),
      agentId,
      taskId: "t43",
    },
    {
      id: "e19",
      type: "task_completed",
      title: "Task #43 completed",
      description: "API docs published to wiki",
      timestamp: m(170),
      agentId,
      taskId: "t43",
    },
    {
      ...
      description: "+5 credits for completing 2 tasks",
      timestamp: m(175),
      agentId,
    },
  ];
...
export function TimelineView({ events: eventsProp, agentId, className }: TimelineViewProps) {
  ...
  if (events.length === 0) {
    return (
      <div
        className={cn(
          "flex flex-col items-center justify-center py-16 text-muted-foreground/70",
          className,
        )}
      >
  ...
  return (
    <div className={cn("flex flex-col gap-3", className)}>
      ...
      <div className="flex items-center gap-2 justify-end">
        ...
        <span className="text-xs text-muted-foreground/70 w-12 text-center">
          {Math.round(zoom * 100)}%
        </span>
        <button
      ...
      >
        <div
          style={{ width: timelineWidth, minHeight: lanes.length * 72 + 48 }}
        ...
        >
          ...
          {lanes.map((lane, laneIdx) => {
            ...
            return (
              <div
                key={lane.taskId ?? "general"}
                className="absolute"
                style={{ top: y, left: 0, right: 0, height: 60 }}
              >
                {/* Lane label */}
                ...
                {laneEvents.map((ev) => (
                  <div
                    key={ev.id}
                    className="absolute"
                    style={{ left: getX(ev.timestamp) - 20, top: 0 }}
                  >
                    <EventNode
                      event={ev}
            ...
            return (
              <div key={ev.id} className="flex gap-3">
                ...
                <div className="flex flex-col items-center">
                  ...
                  {i < events.length - 1 && (
                    <div className="w-px flex-1 bg-border/40 min-h-[16px]" />
                  )}
                </div>
