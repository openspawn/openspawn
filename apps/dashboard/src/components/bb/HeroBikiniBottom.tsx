...
export function HeroBikiniBottom({
  onWatchLive,
  onGitHub,
  agentCount = 22,
}: HeroBikiniBottomProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <nav className="relative z-30 flex items-center justify-between px-6 py-4 md:px-10 md:py-6">
          <div
            ...
            style={
              {
                animation: "bb-enter-up 0.6s 0.1s ease forwards",
                opacity: 0,
                "--bb-enter-y": "20px",
              } as React.CSSProperties
            }
          >
            <span className="text-2xl" role="img" aria-label="pineapple">
              🍍
            </span>
            <span
          ...
          <div
            ...
            style={
              {
                animation: "bb-enter-up 0.6s 0.2s ease forwards",
                opacity: 0,
                "--bb-enter-y": "20px",
              } as React.CSSProperties
            }
        ...
        <div className="relative z-30 flex-1 flex flex-col items-center justify-center px-6 py-12 text-center">
          ...
          >
            <span className="bb-hero-word">Hire</span> <span className="bb-hero-word">the</span>
            <br />
            <span className="bb-hero-word">whole</span> <span className="bb-hero-word">ocean.</span>
          </h1>
      ...
      {/* ================================================================
          ...
          ================================================================ */}
      <section className="relative py-20 px-6 overflow-hidden" style={{ background: "#062A45" }}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            SpongeBob cooks faster than Squidward can deliver. Sandy optimizes everything. Patrick
            helps… mostly. 22 agents, 5 departments, 1{" "}
            <code
            ...
            {[
              {
                act: "Act I",
                title: "The Order",
                desc: "Plankton places the most ambitious order in Bikini Bottom history. Mr. Krabs says yes immediately.",
                icon: "🦠",
                delay: 3,
              },
              {
                act: "Act II",
                title: "Kitchen Heats Up",
                desc: "SpongeBob enters overdrive. Squidward hits his limit. Sandy spins up 3 more Fred clones.",
                icon: "🔥",
                delay: 4,
              },
              {
                act: "Act III",
                title: "Delivery Crisis",
                desc: "The queue hits 200+. Mr. Krabs delegates hard. Flying Dutchman audits the books. Patties delivered.",
                icon: "📦",
                delay: 5,
              },
            ].map((a) => (
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p
              ...
              style={{ color: "rgba(184,228,247,0.6)", fontFamily: "Nunito, sans-serif" }}
            >
              Each agent is a real SpongeBob character with a job title, a team, and way too much to
              do.
            </p>
          </div>
