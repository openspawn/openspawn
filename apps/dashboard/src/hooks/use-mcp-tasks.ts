...
const DEMO_TASKS: KanbanTask[] = [
  ...
  { id: 't6', title: 'Restock condiment station', status: 'claimed', priority: 'low', assignee: 'SpongeBob', createdAt: '2026-02-25T16:00:00Z', updatedAt: '2026-02-26T09:00:00Z' },
  { id: 't7', title: 'Fix drive-thru speaker', status: 'claimed', priority: 'high', assignee: 'Patrick', createdAt: '2026-02-25T12:00:00Z', updatedAt: '2026-02-26T07:00:00Z' },
  { id: 't8', title: 'Optimize grill temperature', status: 'in_progress', priority: 'high', assignee: 'SpongeBob', createdAt: '2026-02-25T10:00:00Z', updatedAt: '2026-02-26T11:00:00Z', description: 'Fine-tune the grill to achieve perfect patty sear at 375°F.' },
  ...
  { id: 't10', title: 'Train new cashier bot', status: 'in_progress', priority: 'normal', assignee: 'Squidward', createdAt: '2026-02-24T09:00:00Z', updatedAt: '2026-02-26T12:00:00Z' },
  { id: 't11', title: 'Paint dining room mural', status: 'in_progress', priority: 'low', assignee: 'Squidward', createdAt: '2026-02-23T14:00:00Z', updatedAt: '2026-02-26T09:00:00Z' },
  { id: 't12', title: 'Review employee schedules', status: 'review', priority: 'high', assignee: 'Mr. Krabs', createdAt: '2026-02-24T08:00:00Z', updatedAt: '2026-02-26T13:00:00Z', description: 'All schedules for next month need final sign-off.' },
  { id: 't13', title: 'Test new kelp shake recipe', status: 'review', priority: 'normal', assignee: 'SpongeBob', createdAt: '2026-02-23T11:00:00Z', updatedAt: '2026-02-26T11:30:00Z' },
  ...
  { id: 't16', title: 'Clean grease traps', status: 'done', priority: 'normal', assignee: 'SpongeBob', createdAt: '2026-02-21T07:00:00Z', updatedAt: '2026-02-25T10:00:00Z' },
  { id: 't17', title: 'Fix bathroom plumbing', status: 'done', priority: 'high', assignee: 'Patrick', createdAt: '2026-02-19T13:00:00Z', updatedAt: '2026-02-24T15:00:00Z' },
  { id: 't18', title: 'Order new spatulas', status: 'done', priority: 'low', assignee: 'SpongeBob', createdAt: '2026-02-18T10:00:00Z', updatedAt: '2026-02-23T09:00:00Z' },
];
