...
function TerminalDemo() {
  const lines = [
    ...
    {
      text: "✨ Agents ready. Visit http://localhost:3333",
    ...
    <div className="terminal glow-cyan mx-auto max-w-2xl">
      ...
      <div className="p-5 min-h-[260px]">
        {lines.slice(0, visibleLines).map((line, i) => (
          <div
            key={i}
            className={`${line.color} ${i === visibleLines - 1 ? "animate-fade-in-up" : ""}`}
          >
            {line.text || "\u00A0"}
          </div>
        ))}
...
const features = [
  {
    ...
    title: "A2A Protocol",
    description:
      "Every agent is discoverable. Native Agent-to-Agent protocol support with streaming, task management, and per-agent cards.",
    color: "text-cyan-400",
  },
  {
    emoji: "🔌",
    title: "MCP Tools",
    description:
      "Your agents become MCP servers — connect from Claude Desktop, Cursor, or any MCP client. Streamable HTTP out of the box.",
  ...
  },
  {
    ...
    title: "Model Router",
    description:
      "Intelligent routing with fallback chains. Local-first with Ollama, cloud when needed. Cost tracking per provider.",
  ...
  },
  {
    ...
    description:
      "Real-time visualization of your agent organization. Network graph, task timeline, cost charts, router metrics.",
  ...
  },
  {
    ...
    title: "CLI",
    description:
      "npx openspawn init — zero config, instant setup. Scaffold, start, and deploy your agent org in seconds.",
    color: "text-cyan-400",
  },
];
      ...
      <nav className="sticky top-0 z-50 border-b border-white/5 bg-navy-950/80 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-6">
          ...
          <div className="hidden items-center gap-8 md:flex">
            <a href="#features" className="text-sm text-slate-400 transition hover:text-cyan-400">
              Features
            </a>
            <a
              href="#how-it-works"
        ...
        <section id="how-it-works" className="py-20">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mb-12 max-w-2xl text-slate-400">
              OpenSpawn turns a flat list of AI agents into a coordinated organization. You define
              the org in ORG.md — teams, roles, hierarchy, policies — and OpenSpawn handles task
              delegation, credit tracking, and communication protocols.
            </p>
        ...
        <section className="py-20">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-slate-400">
              BikiniBottom is a live OpenSpawn deployment with 22 SpongeBob characters running a
              software company. 5 departments. Real-time coordination.
            </p>
            <a
              href="https://bikinibottom.ai"
              target="_blank"
                ...
                <div className="flex items-center justify-center bg-navy-900/30 py-24">
                  <div className="text-center">
                    ...
                    <p className="text-lg font-semibold text-slate-300">
                      BikiniBottom Live Dashboard
                    </p>
                    <p className="mt-2 text-sm text-slate-500">
                      22 agents · 5 departments · Real-time
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mb-8 max-w-xl text-slate-400">
              OpenSpawn is built for OpenClaw agents. Install the skill, add ORG.md to your
              workspace, and your agents understand their role in the organization.
            </p>
